...
data DBExp
  ...
  | DBApp Ident DBExp -- function application (function names stay)
  deriving (Show, Eq)
...
toDB ctx (EApp f e) = DBApp f (toDB ctx e)
...
shift n k (DBApp f e) = DBApp f (shift n k e)
...
subst n u (DBApp f e) = DBApp f (subst n u e)
